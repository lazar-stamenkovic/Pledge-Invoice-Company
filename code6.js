     ...
     console.log("Test"+lineItemId);
      ...
      var req = http.request(options, function (res) {
        ...
        res.on("end", function () {
          ...
          console.log( line_item.price)
          let li_id = line_item.hs_object_id;
          let li_qty = line_item.qauntity;
          let li_name = line_item.name + " OCT2";
          ...
          let li_due_date = line_item.due_date;
            ...
            let answer="";
          if (li_invoice_number == 'yes'){
            answer = 'yes';
          } else if (li_invoice_number == 'no') {
            answer = 'no';
          }

            get_ns_cust_id_req.write(JSON.stringify({properties: {invoice_successfully_created: answer }}));
            get_ns_cust_id_req.end();
            callback({
              outputFields: {
                invoice_successfully_created: answer,
